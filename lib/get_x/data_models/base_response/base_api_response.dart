...
class BaseApiResponse<T> {
  ...
  factory BaseApiResponse.fromObjectJson(Map<String, dynamic> json,
    ...
    return BaseApiResponse<T>(
      objectResult: json["data"] != null ? createObject!(json["data"]) : null,
  ...
  factory BaseApiResponse.fromListJsonWithPagination(Map<String, dynamic> json,
      {required Function(Map<String, dynamic>) create,
        ...
        Function(Map<String, dynamic>)? createLinkObject}) {
    List<T> data = [];
    json['data'].forEach((v) {
      data.add(create(v));
    });
    ...
    return BaseApiResponse<T>(
        ...
        listResult: data,
        links:
        createLinkObject != null ? createLinkObject(json["links"]) : null,
  ...
  factory BaseApiResponse.fromListJson(Map<String, dynamic> json,
    ...
    return BaseApiResponse<T>(
        statusCode: json["status"], message: json["message"], listResult: data);
  }
}
