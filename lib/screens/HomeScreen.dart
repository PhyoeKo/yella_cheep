            ...
            children: [
              ...
              if ((dashboardResponse!.nearByPlaces ?? []).isNotEmpty)
                Column(
                  ...
                  children: [
                    headingWidget(language.nearByPlaces + '\t(${getDoubleAsync(NEAR_BY_PLACE_DISTANCE)} ${language.km})', () {
                      ViewAllScreen(name: language.nearByPlaces, placesType: placesTypeNearBy).launch(context);
                    }),
                    HorizontalList(
