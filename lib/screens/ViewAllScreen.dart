...
class ViewAllScreen extends StatefulWidget {
  ...
  ViewAllScreen({required this.name, this.catId, this.stateId, this.placesType, this.distance});
...
class ViewAllScreenState extends State<ViewAllScreen> {
  ...
  void init() async {
    ...
    if (widget.placesType == placesTypeNearBy && appStore.currentPosition != null) {
      await placeService.nearByPlaces(appStore.currentPosition!, isViewAll: true, catId: widget.catId, distance: widget.distance).then((value) {
