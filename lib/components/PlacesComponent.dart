...
Widget placesComponent(
  PlaceModel place,
  BuildContext context,
  Function onTap, {
  width,
  bool isRequestPlace = false,
  Function()? onUpdate,
}) {
  deletePlace() async {
                      ...
                      if (appStore.currentPosition != null)
                        Row(
                          children: [
                            ...
                            4.width,
                            Text(
                              '${calculateDistanceKm(appStore.currentPosition!.latitude, appStore.currentPosition!.longitude, place.latitude, place.longitude).toStringAsFixed(2)} Km',
                              style: secondaryTextStyle(color: whiteColor),
                            ),
                          ],
                        ).paddingTop(8),
