...
class ReviewComponent extends StatefulWidget {
  ...
  ReviewComponent({required this.place,this.onUpdate});
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                FutureBuilder<int>(
                    future: reviewService.totalReviews(placeId: widget.place.id),
                    builder: (context, snap) {
                      if (snap.hasData) {
                        return snap.data!=0 ? Text('${snap.data} ${language.reviews}', style: primaryTextStyle()) : Spacer();
                      } else {
                        return Spacer();
                      }
                    }),
                Text(language.writeAReview, style: boldTextStyle(color: primaryColor)).onTap(() {
